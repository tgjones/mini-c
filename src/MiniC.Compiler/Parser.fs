...
let optionalLocalDeclarations = nonTerminal<LocalDeclaration list>()
let localDeclarations         = nonTerminal<LocalDeclaration list>()
let localDeclaration          = nonTerminal<LocalDeclaration>()
