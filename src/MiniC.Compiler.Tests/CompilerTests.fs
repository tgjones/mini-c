...
[<TestCase("error7.minic", "MC005 Operator '!=' cannot be applied to operands of type 'bool' and 'int'")>]
[<TestCase("error8.minic", "MC005 Operator '||' cannot be applied to operands of type 'bool' and 'int'")>]
...
[<TestCase("error16.minic", "MC004 Cannot convert type 'bool' to 'int'")>]
[<TestCase("error17.minic", "MC004 Cannot convert type 'float' to 'int'")>]
[<TestCase("error18.minic", "MC004 Cannot convert type 'bool' to 'int'")>]
[<TestCase("error19.minic", "MC004 Cannot convert type 'bool' to 'int[]'")>]
[<TestCase("error20.minic", "MC004 Cannot convert type 'bool' to 'int'")>]
